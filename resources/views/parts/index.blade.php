                    ...
                    <form id="partForm" enctype="multipart/form-data">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="specifications" class="form-control" id="specifications" rows="2"></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <small class="form-text text-muted">Max 2MB, format: JPG, PNG, GIF. Gambar akan dikompres otomatis.</small>
                                ...
                                <div id="currentImagePreview" class="mt-2" style="display: none;">
                                    <p>Gambar Saat Ini:</p>
                                    <img id="imagePreviewTag" src="" alt="Current Image" class="img-thumbnail" style="max-width: 150px; height: auto; border-radius: 5px;">
                                    <button type="button" class="btn btn-sm btn-danger ms-2" id="removeImageButton">Hapus Gambar</button>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <button type="button" class="btn btn-secondary" id="cancelEditButton" style="display:none;">Batal</button>
                            </div>
                        </div>
                    </form>
                </div>
